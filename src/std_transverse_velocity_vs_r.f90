program los_pvd_vs_rmu
    ...
    real*8 :: disx, disy, disz, dis, vrad, vtra
    ...
    real*8, dimension(:), allocatable :: DD, VV, VV2, std_vtra
                    ...
                    if (ii .ne. 0) then
                        do
                            ...
                            if (dis .gt. dim1_min .and. dis .lt. dim1_max) then
                                ...
                                DD(rind) = DD(rind) + 1
                                VV(rind) = VV(rind) + vtra
                                VV2(rind) = VV2(rind) + vtra**2
                            end if
    ...
    do i = 1, dim1_nbin
        std_vtra(i) = sqrt((VV2(i) - (VV(i)**2/DD(i)))/(DD(i) - 1))
    end do
